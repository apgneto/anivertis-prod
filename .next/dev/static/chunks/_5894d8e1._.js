...
;
;
// ❌ REMOVIDO: import { coletarDadosReais } from '../services/real-data.service';
...
_c = SanitaryShield;
// --- MODAL DE LEITURA ---
const DiscoveryModal = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["memo"])(({ report, onClose })=>{
...
_c2 = PillarCard;
// --- PREDICTOR DASHBOARD ---
const PredictorDashboard = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["memo"])(({ report })=>{
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                        ...
                        children: [
                            CATEGORY_ICONS[item.category?.toUpperCase()] || '📰',
                            " ",
                            item.category || 'GERAL'
                        ]
                    }, void 0, true, {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                        ...
                        children: item.timestamp ? new Date(item.timestamp).toLocaleDateString('pt-BR') : 'Hoje'
                    }, void 0, false, {
                        fileName: "[project]/src/app/page.tsx",
                        lineNumber: 118,
                        columnNumber: 7
...
_c4 = ClippingCard;
// --- BI SESSION ---
const BISession = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["memo"])(({ news })=>{
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
const App = ()=>{
    _s();
    const [activeTab, setActiveTab] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('feed'); // 🎯 Mudado para abrir direto no Clipping!
    ...
    const [discoveryReports, setDiscoveryReports] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const [refreshStatus, setRefreshStatus] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    const [clippingFilter, setClippingFilter] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('TODOS');
    ...
    // 🔥 Carregamento inicial lendo a API local
    ...
    const handleFetch = async ()=>{
        ...
        try {
            // ✅ CHAMA A NOSSA API DIRETAMENTE (Leitura instantânea!)
            const response = await fetch('/api/dados?limit=100');
            const resultado = await response.json();
            if (resultado.success && resultado.dados && resultado.dados.length > 0) {
                // Mapeia os dados do banco para o formato visual dos cards
                setNews(resultado.dados.map((n)=>({
                        id: n.id,
                        title: n.title,
                        summary: n.content?.substring(0, 150) + '...' || 'Conteúdo disponível no link.',
                        url: n.url,
                        category: n.theme || 'GERAL',
                        source: n.source_name,
                        timestamp: n.published_at || n.collected_at
                    })));
                setRefreshStatus(`✅ Intel atualizada! ${resultado.dados.length} registros prontos.`);
            } else {
    ...
    const filteredClipping = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "App.useMemo[filteredClipping]": ()=>clippingFilter === 'TODOS' ? news : news.filter({
                "App.useMemo[filteredClipping]": (item)=>item.category?.toUpperCase() === clippingFilter.toUpperCase()
            }["App.useMemo[filteredClipping]"])
    }["App.useMemo[filteredClipping]"], [
        news,
        clippingFilter
    ]);
    const predictorReport = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "App.useMemo[predictorReport]": ()=>discoveryReports.length > 0 ? discoveryReports.find({
                "App.useMemo[predictorReport]": (r)=>r.category === 'RECICLAGEM'
            }["App.useMemo[predictorReport]"]) || discoveryReports[0] : null
    }["App.useMemo[predictorReport]"], [
        discoveryReports
    ]);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
                ...
                children: [
                    activeTab === 'predictor' && (predictorReport ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(PredictorDashboard, {
                        ...
                        className: "text-center py-32 opacity-30 text-2xl font-black uppercase tracking-widest text-slate-400",
                        children: "Aguardando Análise Preditiva..."
                    }, void 0, false, {
                        fileName: "[project]/src/app/page.tsx",
                        lineNumber: 231,
                        columnNumber: 108
                    }, ("TURBOPACK compile-time value", void 0))),
                    activeTab === 'discovery' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "grid grid-cols-1 md:grid-cols-2 gap-8",
                        children: discoveryReports.length > 0 ? discoveryReports.map((report)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            className: "col-span-2 text-center py-32 opacity-30 text-2xl font-black uppercase tracking-widest text-slate-400",
                            children: "Aguardando Briefings..."
                        }, void 0, false, {
                            fileName: "[project]/src/app/page.tsx",
                            lineNumber: 243,
                            columnNumber: 19
                    ...
                    activeTab === 'bi' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(BISession, {
                        news: news
                    }, void 0, false, {
                        fileName: "[project]/src/app/page.tsx",
                        lineNumber: 246,
                    ...
                    activeTab === 'feed' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        ...
                                        className: `px-8 py-3.5 rounded-full text-[10px] font-black uppercase ${clippingFilter === 'TODOS' ? 'bg-slate-900 text-white' : 'bg-white shadow-sm'}`,
                                        children: "Todos"
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/page.tsx",
                                        lineNumber: 250,
                                    ...
                                    Object.keys(CATEGORY_ICONS).filter((cat)=>cat !== 'GERAL').map((cat)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                            onClick: ()=>setClippingFilter(cat),
                                            className: `px-8 py-3.5 rounded-full text-[10px] font-black uppercase whitespace-nowrap shadow-sm ${clippingFilter === cat ? 'bg-green-600 text-white' : 'bg-white hover:bg-slate-50'}`,
                                            children: cat
                                        }, cat, false, {
                                            fileName: "[project]/src/app/page.tsx",
                                            lineNumber: 252,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: filteredClipping.length > 0 ? filteredClipping.map((item)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ClippingCard, {
                                        item: item
                                    }, item.id, false, {
                                        fileName: "[project]/src/app/page.tsx",
                                        lineNumber: 257,
                                    ...
                                    className: "col-span-full text-center py-20 text-slate-400 font-bold uppercase tracking-widest",
            ...
            selectedReport && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(DiscoveryModal, {
...
_s(App, "KjzIMUs9Us+Bbcg05t9+wpeDs2A=");
_c6 = App;
const __TURBOPACK__default__export__ = App;
var _c, _c1, _c2, _c3, _c4, _c5, _c6;
__turbopack_context__.k.register(_c, "SanitaryShield");
__turbopack_context__.k.register(_c1, "DiscoveryModal");
__turbopack_context__.k.register(_c2, "PillarCard");
__turbopack_context__.k.register(_c3, "PredictorDashboard");
__turbopack_context__.k.register(_c4, "ClippingCard");
__turbopack_context__.k.register(_c5, "BISession");
...
//# sourceMappingURL=_5894d8e1._.js.map