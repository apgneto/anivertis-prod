// engine/teste-integracao.js
// ✅ CORRIGIDO - USANDO REQUIRE (COMMONJS)

const engineAdapter = require('../services/engine-adapter.service.js');
const { pipelineV52 } = require('../services/PipelineV52.js');
